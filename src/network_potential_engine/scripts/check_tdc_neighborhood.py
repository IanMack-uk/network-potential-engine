...
def main() -> None:
    ...
    print("=" * 72)
    print("TDC NEIGHBORHOOD SUMMARY")
    print("=" * 72)
    print(f"Minimum curvature margin   : {summary.min_curvature_margin:.6f}")
    print(f"Minimum mixed-block margin : {summary.min_mixed_block_margin:.6f}")
    print(f"Curvature condition everywhere   : {summary.curvature_condition_holds_everywhere}")
    print(f"Mixed-block condition everywhere : {summary.mixed_block_condition_holds_everywhere}")
    print(f"All sufficient conditions hold   : {summary.all_conditions_hold_everywhere}")
    print("\nDone.")
